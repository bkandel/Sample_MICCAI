...
(A) & (B)
\end{tabular}
\caption{ Intrahemisheric connectivity in the default mode network of an individual subject is visualized using A) ROI averaged combined CBF and BOLD and B) SCCA based combined CBF and BOLD.}
\label{fig:dmn}
\end{center}
\end{figure}
