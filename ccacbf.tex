...
\section*{Methods}
Denote the matrices that describe the ASL-BOLD or CBF time series within a brain ROI as $X$ and $Y$ respectively.  Denote a ASL-BOLD sub-matrix extracted from ROI$^i$ as $X^i$.  Then $Y^i$ will contain the same ROI's ASL-CBF measurements.
